...
class Settings(BaseSettings):
    ...
    llm_image_base_url: str = Field(default="", alias="LLM_IMAGE_BASE_URL")
    llm_image_api_key: str = Field(default="", alias="LLM_IMAGE_API_KEY")
    llm_image_model: str = Field(default="gpt-image-1", alias="LLM_IMAGE_MODEL")
